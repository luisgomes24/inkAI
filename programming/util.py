...
def generate_var_name(
    use_letter=True, use_numbers=True, probability_extension=0.6, shuffle=True
):
    nouns = [
        "people",
        "history",
    ...
    extensions = [".png", ".jpeg", ".abc", ".txt", ".sde"]

    n1 = random.choice(nouns)
    n2 = random.choice(nouns)
    l = random.choice(letters_uc)
    ...
    if random.uniform(0, 1) > probability_extension:
        name.append(e)
